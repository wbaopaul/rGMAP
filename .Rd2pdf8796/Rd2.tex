...
\item[Version]\AsIs{1.3.1}
\item[Date]\AsIs{08-23-2018}
\item[Author]\AsIs{Wenbao Yu}
\item[Maintainer]\AsIs{Wenbao Yu }\email{yuw1@email.chop.edu}\AsIs{}
\item[Description]\AsIs{Call hierarchical chromatin domains from HiC contact map by Gaussian Mixture model And Proportion test}
...
\begin{Usage}
\begin{verbatim}
data_simu(stype = "poisson-dist", nratio = 2.5, mu0 = 200, resl = 1)
\end{verbatim}
\end{Usage}
%
\begin{Arguments}
