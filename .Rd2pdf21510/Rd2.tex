...
\begin{Usage}
\begin{verbatim}
rGMAP(hic_mat, resl = 10 * 10^3, logt = T, dom_order = 2, min_d = 25,
  max_d = 100, min_dp = 5, max_dp = 10, maxDistInBin = min(200, 2 *
  10^6/resl), hthr = 0.95, t1thr = 0.5)
\end{verbatim}
\end{Usage}
%
\begin{Arguments}
