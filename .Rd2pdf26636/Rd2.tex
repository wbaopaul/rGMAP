...
\item[Description]\AsIs{Call hierarchical chromatin domains from HiC contact matrix by Gaussian Mixture model And Proportion test, for more details see paper: Yu, W., He, B., & Tan, K. (2017). Identifying topologically associating domains and subdomains by Gaussian Mixture model And Proportion test. Nature Communications, 8, 535.}
